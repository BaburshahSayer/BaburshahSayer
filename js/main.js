     ...
     $('.fancybox').fancybox({
         ...
         afterLoad: function() {
             ...
             if (this.element.find("p").html())
                 ...
                 this.title = '<div style="padding:20px">' + this.title + '<div style="padding-top:10px"><a target="_blank"	 href="' + this.element.find("img").attr("alt") + '" class="btn smoothscroll btn-primary">See on GitHub</a></div></div>';
             }
